...
/// 2.1 API, no redirect
casper.test.begin("2.1 API, no redirect", 8, function(test) {
  casper.start(common.base + '/foundry/soda.demo.socrata.com/b6kv-3wgw', function() {
    // Check that we got our base page
    test.assertExists('#foundry-docs', 'foundry docs target element exists');
